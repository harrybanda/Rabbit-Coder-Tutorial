...
- https://sparkar.facebook.com/ar-studio/learn/reference/scripting/summary/[Spark AR Scripting API]

- https://sparkar.facebook.com/ar-studio/learn/articles/particles/particle-systems[Spark AR Particle System]

- https://sparkar.facebook.com/ar-studio/learn/articles/audio/audio-playback-controller/[Audio Playback Controller]

- https://sparkar.facebook.com/ar-studio/learn/articles/animation/2d-texture-animation/[2D Texture Animations]


=== What We'll Build

This tutorial will guide you in a step-by-step process to create an augmented reality puzzle game called https://devpost.com/software/rabbit-coder[Rabbit Coder]. I created this game for the first Facebook AR hackathon and the project won first place. You can try out the game https://www.facebook.com/fbcameraeffects/tryit/208527660353698/[here]. By the end of this tutorial, you should have learned how to build this game in Spark AR, you can then use this as a template to build other awesome games.
...
* https://sparkar.facebook.com/ar-studio/learn/downloads/[Spark AR Studio] v102 and above
...
. https://github.com/harrybanda/Rabbit-Coder-Sample-Starter[Download the unfinished sample project].
...
In Spark AR Studio you can use https://sparkar.facebook.com/ar-studio/learn/articles/animation/2d-texture-animation/[2D textures to create animations]. You’ll add your own textures then turn them into an animation using an asset included in Spark AR Studio called an Animation Sequence.
...
In this section, we are going to focus on writing game logic with the https://sparkar.facebook.com/ar-studio/learn/reference/scripting/summary/[Spark AR Scripting API].
...
In the code above the `require()` method tells the script we're looking for a module, we pass in the name of the module as the argument to specify the one we want to load. The *Scene* variable now contains a reference to the https://sparkar.facebook.com/ar-studio/learn/reference/classes/scenemodule[*Scene Module*] that can be used to access the module's properties, methods, classes, and enums. Now we are going to add the code below:
...
From the code, above we have imported the https://sparkar.facebook.com/ar-studio/learn/reference/classes/audiomodule[*Audio module*] and added `getAudioPlaybackController`, the https://sparkar.facebook.com/ar-studio/learn/articles/audio/audio-playback-controller/[audio playback controller] can be used to play sound continuously on a loop in your AR effect or add one-shot triggered audio in response to boolean signals. We have also added variables that correspond to the game and audio objects.
...
The https://sparkar.facebook.com/ar-studio/learn/reference/classes/touchgesturesmodule[*TouchGestures*] module enables touch gesture detection, in our case we are going to use it to detect screen taps and the https://sparkar.facebook.com/ar-studio/learn/reference/classes/materialsmodule[*Materials*] module provides access to the materials in the effect.
...
The https://sparkar.facebook.com/ar-studio/learn/reference/classes/timemodule[*TimeModule*] class we added above enables time-based events.
...
Now that our command execution code is all set up let us focus on Animations, to make the rabbit move forward and turn we are going to use Spark AR's https://sparkar.facebook.com/ar-studio/learn/reference/classes/animationmodule[*Animation Module*]. Add the following function:
...
Currently, the rabbit can move but we need a way to check if the rabbit has reached the goal or fallen off the path, to do that we are going to use the Spark AR https://sparkar.facebook.com/ar-studio/learn/reference/classes/reactivemodule[*Reactive Module*]. 
...
https://sparkar.facebook.com/ar-studio/learn/articles/particles/particle-systems[*Particle systems*] let you display and move large numbers of objects, called particles. You can apply force and drag to particles to mimic the effects of gravity.
